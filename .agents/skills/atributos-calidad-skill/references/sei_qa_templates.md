...
Este documento contiene los templates generales y específicos de las 6 partes del Software Engineering Institute (SEI) descriptos en *Software Architecture in Practice*, 4ta Ed. (Bass, Clements & Kazman).
...
### F. Interoperabilidad (Interoperability)
