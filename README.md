...
Las pruebas documentadas en [`examples/test_cases.md`](./.agents/skills/atributos-calidad-skill/examples/test_cases.md) demuestran el correcto funcionamiento sobre:
